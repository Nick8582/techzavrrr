<template>
  <aside class="filter">
    ...
    <form class="filter__form form" action="#" method="get" @submit.prevent="submit">
      ...
      <button class="filter__reset button button--second" type="button" @click.prevent="reset" v-show="showReset">
        Сбросить
      </button>
    </form>
  </aside>
...
export default {
  ...
  computed: {
    ...
    showReset() {
      return this.currentPriceFrom || this.currentPriceTo || this.currentCategoryId || this.currentColorId;
    },
  },
  watch: {
    priceFrom(value) {
