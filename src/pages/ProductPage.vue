<template>
  <LoaderPage v-if="productLoading"/>
  <LoaderErrorPage :message="товара" :reboot-load="loadProduct" v-else-if="productLoadingFailed"/>
  <ContentTopProduct :product="product" v-else/>

  <section class="item" v-if="productData != null">
    ...
    <div class="item__info">
      ...
      <div class="item__form">
        <form class="form" action="#" method="POST" @submit.prevent="addToCart">
          ...
          <div class="item__row">
            <AppCounter v-model:product-amount="productAmount"/>
...
import ContentTopProduct from "@/components/ContentTop/ContentTopProduct";

export default {
  name: 'ProductPage',
  components: {ContentTopProduct, AppCounter, LoaderErrorPage, LoaderPage},
  data() {
    return {
      productAmount: 1,
      productData: null,
